...
class Database
{
    ...
    // You can pass in nothing, a string, or a db result
    /*
    public function getValues($arg = null, $args_to_prepare = array())
    {
        $result = $this->resulter($arg, $args_to_prepare);
        if (!$result)
        {
    ...
    // You can pass in nothing, a string, or a db result
    public function getRow($arg = null, $args_to_prepare = array(), $fetchType = PDO::FETCH_BOTH)
    {
        $result = $this->resulter($arg, $args_to_prepare);
    ...
    // You can pass in nothing, a string, or a db result
    public function getRows($arg = null, $args_to_prepare = array(), $fetchType = PDO::FETCH_BOTH)
    {
        $result = $this->resulter($arg, $args_to_prepare);
